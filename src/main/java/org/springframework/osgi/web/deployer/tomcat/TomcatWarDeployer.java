...
public class TomcatWarDeployer extends AbstractWarDeployer {
	...
	private static final String TOMCAT_HOTDEPLOY = "org.springframework.osgi.web.deployer.tomcat.hotdeploy";
	private static final String TOMCAT_WORKSPACE = "org.springframework.osgi.web.deployer.tomcat.workspace";
